            ...
            <div class="peta-cards">
                ...
                <div class="peta-card">
                    ...
                    <div class="peta-card-content">
                        ...
                        <!-- LINK HOTEL -->
                        <a href="https://www.google.com/maps/search/?api=1&query=Hotel+Santika+Bogor"
                           target="_blank"
                           class="btn btn-blue btn-full mt-3">
                            <i class="fas fa-external-link-alt"></i>
                            Buka di Google Maps
                ...
                <!-- RS -->
                <div class="peta-card">
                    <img src="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=400&q=80"
                        alt="RS"
                        class="peta-card-img">
                    ...
                    <div class="peta-card-content">
                        ...
                        <!-- LINK RS -->
                        <a href="https://www.google.com/maps/search/?api=1&query=RS+PMI+Kota+Bogor"
                           target="_blank"
                           class="btn btn-blue btn-full mt-3">
                            <i class="fas fa-external-link-alt"></i>
                            Buka di Google Maps
